...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD ValidateCustomer.
    ...
    DATA travels TYPE TABLE FOR READ RESULT ZR_09_TravelTP.

    " Read Travels

    READ ENTITIES OF ZR_09_TravelTP IN LOCAL MODE
         ENTITY Travel
         FIELDS ( CustomerId )
  ...
  METHOD DetermineStatus.
    DATA travels TYPE TABLE FOR UPDATE zr_09_travelTP.
    ...
    MODIFY ENTITIES OF zr_09_TravelTP IN LOCAL MODE
           ENTITY travel
           UPDATE
           FIELDS ( status )
           WITH travels.
